            ...
            {form.lavado_tanques && (
              <div className="mt-3 flex items-center gap-2 p-2 bg-cyan-50 border border-cyan-200 rounded-md">
                ...
                <input
                  ...
                  onChange={e => setForm(f => ({ ...f, lavado_tanques_cantidad: e.target.value === '' ? '' : parseInt(e.target.value) || 1 }))}
                  onBlur={e => setForm(f => ({ ...f, lavado_tanques_cantidad: parseInt(e.target.value) || 1 }))}
